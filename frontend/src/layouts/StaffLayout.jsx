...
import { Menu, X, Bell, Coins, Wrench, User } from 'lucide-react';
          ...
          <div className="relative z-10 w-72 bg-slate-950 flex flex-col h-full border-r border-slate-800">
            <div className="flex items-center justify-between p-4 border-b border-slate-800">
              <span className="font-bold text-white flex items-center gap-2">
                <Coins className="text-sky-400" size={20} /> Staff Portal
              </span>
              <button
                onClick={() => setMobileSidebarOpen(false)}
        ...
        <header className="sticky top-0 z-30 h-16 border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-xl px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex items-center gap-2 text-xs text-slate-400">
              <span className="font-semibold text-slate-300">Staff / Department</span>
              <span>/</span>
              <span className="text-sky-400">Task Console</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <div className="w-8 h-8 rounded-lg bg-sky-500/20 text-sky-300 border border-sky-500/30 flex items-center justify-center font-bold text-xs overflow-hidden">
